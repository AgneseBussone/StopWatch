...
/**
 * Class to manage the filling of the center circle with the accent color as the timer runs.
 */
...
public class CircleFillView extends View {
    ...
    public CircleFillView(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            fillColor = a.getColor(R.styleable.CircleFillView_fillColor, Color.TRANSPARENT);
            strokeColor = a.getColor(R.styleable.CircleFillView_strokeColor, Color.TRANSPARENT);
            strokeWidth = a.getFloat(R.styleable.CircleFillView_strokeWidth, 0f);
